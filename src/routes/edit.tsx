import { ActionFunction, Form, LoaderFunction, redirect, useLoaderData, useNavigate } from 'react-router-dom';
...
export const action: ActionFunction = async ({ request, params }) => {
  ...
  await updateContact(params.contactId as string, updates as unknown as Contact);
